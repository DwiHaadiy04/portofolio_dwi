...
<div className="flex gap-3 order-2 md:order-none">
  <a href="https://github.com/DwiHaadiy04" target="_blank" rel="noopener noreferrer">
    <i className="ri-github-fill ri-2x"></i>
  </a>

   <a href="https://www.linkedin.com/in/dwihaadiypalguna" target="_blank" rel="noopener noreferrer">
    <i className="ri-linkedin-fill ri-2x"></i>
  </a>

  {/* Email (pengganti Gmail icon) */}
  <a href="mailto:dwihadyp@gmail.com">
